...
impl Action {
    pub fn script_type(&self) -> Result<u8, Error> {
...
impl Otx {
    pub fn flag(&self) -> Result<u8, Error> {
        let cur = self.cursor.table_slice_by_index(0usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn fixed_input_cells(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(1usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn fixed_output_cells(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(2usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn fixed_cell_deps(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(3usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn fixed_header_deps(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(4usize)?;
        cur.try_into()
    }
}
...
impl Otx {
    pub fn dynamic_input_cells(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(6usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn dynamic_output_cells(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(7usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn dynamic_cell_deps(&self) -> Result<u32, Error> {
        let cur = self.cursor.table_slice_by_index(8usize)?;
        cur.try_into()
    }
}
impl Otx {
    pub fn dynamic_header_deps(&self) -> Result<u32, Error> {
...
impl Otx {
    pub fn verify(&self, compatible: bool) -> Result<(), Error> {
        self.cursor.verify_table(11usize, compatible)?;
        self.message()?.verify(compatible)?;
